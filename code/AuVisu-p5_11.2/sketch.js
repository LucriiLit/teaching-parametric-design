...
function draw() {
  ...
  push();
    ...
    push();
    ambientMaterial(colorRoom, 0, colorRoom)  
    translate(0, 250, 0);
    rotateX(HALF_PI);
    plane(500, 500);0
    pop();
    ...
    push();
    ambientMaterial(colorRoom + 5, 0, colorRoom + 5)  
    translate(0, -250, 0);
    rotateX(HALF_PI);
    plane(500, 500);0
    pop();
    ...
    push();
    ambientMaterial(colorRoom + 10, 0, colorRoom + 10)  
    translate(0, 0, -250);
    plane(500, 500);0
    pop();

    push();
    ambientMaterial(colorRoom + 15, 0, colorRoom + 15)  
    translate(250, 0, 0);
    rotateY(HALF_PI);
    plane(500, 500);0
    pop();
    ...
    push();
    ambientMaterial(colorRoom + 20, 0, colorRoom + 20)  
    translate(-250, 0, 0);
    rotateY(HALF_PI);
    plane(500, 500);0
    pop();
